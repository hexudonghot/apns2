...
type ClientManager struct {
	...
	// manager.
	Factory func(certificate tls.Certificate, skip bool) *Client
...
func (m *ClientManager) Get(certificate tls.Certificate, skip bool) *Client {
	m.initInternals()
	m.mu.Lock()
	defer m.mu.Unlock()
